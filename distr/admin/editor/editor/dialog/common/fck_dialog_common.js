...
function openLinkWindow(target,doc) {
    ...
    window.open('../../../index.php?doc='+doc+'&target=txtUrl&do=docs&action=showsimple_edit&pop=1','pop','left=0,top=0,width='+width+',height='+height+',scrollbars='+scrollbar+',resizable=1');
}

function openLinkWindowLnkUrl(target,doc) {
    if (typeof width=='undefined' || width=='') var width = screen.width * 0.6;
    if (typeof height=='undefined' || height=='') var height = screen.height * 0.6;
    if (typeof doc=='undefined') var doc = 'Titel';
    if (typeof scrollbar=='undefined') var scrollbar=1;
    window.open('../../../index.php?doc='+doc+'&target=txtLnkUrl&do=docs&action=showsimple_edit&pop=1','pop','left=0,top=0,width='+width+',height='+height+',scrollbars='+scrollbar+',resizable=1');
}