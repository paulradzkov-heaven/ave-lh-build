...
<div class="h_module"></div>
    <div class="HeaderTitle"><h2>{#DownloadNew#}</h2></div>
    <div class="HeaderText">&nbsp;</div>
</div>
<br />

<form action="index.php?do=modules&action=modedit&mod=download&moduleaction=new&cp={$sess}&pop=1&sub=save" method="post" enctype="multipart/form-data">
...
{/foreach}
 ...
 <label><input name="Aktiv" type="radio" value="0" />{#No#}	</label>  </td>
  ...
  <tr>
    <td colspan="2" class="second">{$Limitierung}</td>
    </tr>
  ...
  <tr>
    ...
    <td class="second"><input style="width:300px" type="text" name="Version"></td>
  </tr>
  <tr>
...
<input value="{#Mediapool#}" class="button" type="button" onclick="cp_imagepop('img_feld__1','','','0');" /> </td>
  ...
  <tr>
    ...
    <td class="second">
	<input name="Wertungen_ja" type="radio" id="Wertungen_ja" value="1" checked="checked" />
	{#Yes#}
	<input name="Wertungen_ja" type="radio" id="Wertungen_ja" value="0" />{#No#}	</td>
  </tr>

    <tr>
    <td class="first">{#CommentsAlowed#}</td>
    <td class="second">
	<input name="Kommentar_ja" type="radio" value="1" checked="checked" />
	{#Yes#}
	<input name="Kommentar_ja" type="radio" value="0" />{#No#}	</td>
  </tr>
  ...
  <tr>
    ...
    <td class="second"><input name="Pay" type="text" id="pay_count" value="0" /></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td class="second">
		<input name="Pay_Type" type="radio" value="0" checked="checked" />{#DlUp#}
		<input name="Pay_Type" type="radio" value="1" />{#DlOnePay#}</td>
  </tr>
  <tr>
    <td class="first">{#DlOnlyPayOk#}</td>
    <td class="second">
		<input name="Only_Pay" type="radio" value="1" checked="checked" />{#Yes#}
		<input name="Only_Pay" type="radio" value="0" />{#No#}</td>
  </tr>
  <tr>
    <td class="first">{#DlVipPayFull#}</td>
    <td class="second">
		<input name="Excl_Pay" type="radio" value="1" />{#Yes#}
		<input name="Excl_Pay" type="radio" value="0" checked="checked" />{#No#}
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{#DlSales#} <input name="Excl_Chk" type="checkbox">
		</td>
  </tr>
  <tr>
