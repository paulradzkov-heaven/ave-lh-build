...
<form method="post" action="index.php?do=modules&action=modedit&mod=videoplayer&moduleaction=save&sub=savenew&cp={$sess}">
<table width="100%" border="0" cellpadding="8" cellspacing="1" class="tableborder">
  ...
  <tr>
    ...
    <td class="second">
      <input type="text" name="VideoTitle" value="" id="VideoTitle" style="width:300px;" />
    </td>
  </tr>
  <tr>
...
<input style="width: 300px;" name="FileName" value="" id="img_feld__FileName" type="text"> <input value="{#VIDEO_SERVER#}" class="button" onclick="cp_imagepop('img_feld__FileName','','','0');" type="button">
</div>
...
<input style="width: 300px;" name="ImagePreview" value="" id="img_feld__ImagePreview" type="text"> <input value="{#VIDEO_SERVER#}" class="button" onclick="cp_imagepop('img_feld__ImagePreview','','','0');" type="button">
</div>
    </td>
  </tr>
  <tr>
    ...
    <td class="second">
      <input type="text" name="Duration" value="" id="Duration" style="width:50px;" /> {#VIDEO_EDIT_SEC#}
    </td>
  </tr>
  <tr>
    <td width="200" class="first" valign="top">{#VIDEO_EDIT_BufferLength#}</td>
    <td class="second">
      <input type="text" name="BufferLength" value="" id="BufferLength" style="width:50px;" /> {#VIDEO_EDIT_SEC#}
    </td>
  </tr>
  <tr>
    <td width="200" class="first" valign="top">{#VIDEO_EDIT_Width#}</td>
    <td class="second">
      <input type="text" name="Width" value="" id="Width" style="width:50px;" />&nbsp;õ&nbsp;<input type="text" name="Height" value="" id="Height" style="width:50px;" /> {#VIDEO_EDIT_PIX#}
    </td>
  </tr>
  <tr>
    ...
    <td class="second">
      <select name="AllowFullScreen" id="AllowFullScreen">
        <option value="true">{#VIDEO_YES#}</option>
        <option value="false">{#VIDEO_NO#}</option>
      </select>
    </td>
  </tr>
  <tr>
...
<input type="hidden" value="savenew" name="sub" />
  <tr>
