...
{*
Ўаблон вывода полей-изображений в документах
≈сли создать шаблон с именем field-XXX.tpl, где XXX это id пол€
...
{elseif $imgtype == 'bild_rechts'}
	<img style="padding-left:6px" align="right" alt="{$imgtitle}" src="{$imglink}" border="0" {$imgsize[3]} />
